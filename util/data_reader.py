...
class DataReader:
    def __init__(self, folder_name, prefix, shuffle=True, prefetch_num=8,iters_per_log=100):
        ...
        self.n_epoch = 0
        self.n_iter=0
        self.iters_per_log=iters_per_log
    ...
    def read_batch(self, is_log = True):
        is_log = (self.n_iter == 0 and self.n_iter % self.iters_per_log == 0)
        if is_log:
