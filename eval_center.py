...
from utils.metrics import Evaluator, Evaluator_seen_unseen
...
class Trainer:
    def __init__(self, args):
        ...
        if args.resume is not None:
            if not os.path.isfile(args.resume):
                raise RuntimeError("=> no checkpoint found at '{args.resume}'")
    ...
    def validation(self, epoch, args):
        ...
        print("Overall: Acc:{Acc}, Acc_class:{Acc_class}, mIoU:{mIoU}, fwIoU: {FWIoU}")
        print(
